...
export default function AboutPage() {
  return (
    <InfoPageLayout eyebrow="ABOUT JAMGYEOL" title="잠결 소개" description="잠결은 기억에 남은 꿈을 과장하거나 단정하지 않고, 상징과 감정의 맥락을 차분하게 살펴보는 꿈해몽·꿈풀이 서비스입니다.">
      ...
      <section><h2>이용 방법</h2><ol><li>홈의 꿈 이야기 입력란에 기억나는 장면과 감정을 적어주세요.</li><li>꿈풀이 보기를 누르면 한눈에 보는 풀이와 종합 풀이, 상징과 감정을 차분히 확인할 수 있습니다.</li><li>특정 상징이 궁금하다면 <Link href="/dictionary">꿈 사전</Link>에서 93가지 핵심 상징과 상황별 풀이를 찾아보세요.</li></ol></section>
