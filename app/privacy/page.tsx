...
export default function PrivacyPage() {
  return (
    <InfoPageLayout eyebrow="PRIVACY POLICY" title="개인정보처리방침" description="잠결은 꿈 내용을 최소한으로 처리하고, 서비스 제공에 필요하지 않은 개인정보를 수집하지 않는 것을 원칙으로 합니다." updatedAt="2026년 7월 18일">
      ...
      <section><h2>2. 꿈 내용의 처리와 저장</h2><p><strong>사용자가 입력한 꿈 원문은 잠결의 데이터베이스나 분석 기록에 저장하지 않습니다.</strong> 꿈 내용은 해당 요청의 결과를 준비하는 동안에만 처리되며, 서비스 운영 로그에도 원문 전체를 남기지 않습니다. 짧은 시간 안에 같은 요청이 반복될 때 불필요한 처리를 줄이기 위해 원문을 알아보기 어려운 해시와 이미 완성된 풀이 결과가 최대 5분간 임시 보관될 수 있습니다. 결과 준비에 필요한 외부 처리 서비스로 내용이 일시 전달될 수 있으나 서비스 제공 목적 외로 사용하지 않습니다.</p></section>
